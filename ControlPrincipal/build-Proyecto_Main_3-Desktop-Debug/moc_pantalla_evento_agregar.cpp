...
#include "../Proyecto_Main_3/pantalla_evento_agregar.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_pantalla_evento_agregar_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_pantalla_evento_agregar_t qt_meta_stringdata_pantalla_evento_agregar = {
    {
QT_MOC_LITERAL(0, 0, 23) // "pantalla_evento_agregar"
...
const QMetaObject pantalla_evento_agregar::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_pantalla_evento_agregar.data,
      qt_meta_data_pantalla_evento_agregar,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *pantalla_evento_agregar::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_pantalla_evento_agregar.stringdata0))
